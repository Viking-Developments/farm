      ...
      rewardPools: [
        {
          ...
          tokens: [
            {
              id: 'UNI-LP',
              address: config.xbseuniswaptoken,
              symbol: 'UNI',
              abi: config.erc20ABI,
              decimals: 18,
              rewardsAddress: config.xbsepoolone,
        ...
        },
        {
          ...
          tokens: [
            {
              id: 'UNI-LP',
              address: config.bseuniswaptoken,
              symbol: 'UNI',
              abi: config.erc20ABI,
              decimals: 18,
              rewardsAddress: config.xbsepooltwo,
              rewardsABI: config.xbserewardsabi,
              rewardsSymbol: 'xBSE',
              decimals: 18,
              balance: 0,
        ...
        },
        {
          ...
          tokens: [
            {
              id: 'UNI-LP',
              address: config.xbsebseuniswaptoken,
              symbol: 'UNI',
              abi: config.erc20ABI,
              decimals: 18,
